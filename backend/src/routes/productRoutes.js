...
router.post('/', authMiddleware, roleMiddleware(ADMIN_ROLES), ProductController.create);
router.put('/:id', authMiddleware, roleMiddleware(ADMIN_ROLES), ProductController.update);
